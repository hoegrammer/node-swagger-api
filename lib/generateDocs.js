...
function setupDirs(options, callback) {
  ...
  console.log("Created foo" + apiDocDir);
  console.log(dirInfo);
...
module.exports.run = function(options, callback) {
  ...
  if (!options.apiDestPath) options.apiDestPath = '/api'; // subfolder within public
  if (!options.apiResourceFilename) options.apiResourceFilename = 'resources.json';
