...
function routeForApiOp(info, api, op, templates) {
...
function commentForApiOp(info, api, op, modelInfo, templates) {
  var comment = [];
  var modelJson, paramName;
  comment.push("/**");
...
function responseForApiOp(info, api, op, modelInfo, templates) {
