/**
*  Generate stubbed express controllers/routes from Swagger api specs
*/

'use strict';

var generateControllers = require('../lib/generateControllers');
...
generateControllers.run(options, function(err, buildDir) {
  if (err) {
